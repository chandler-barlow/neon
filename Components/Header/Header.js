  ...
  return (
    <div className={styles.container}>
      <div className={styles.headerContainer}>
        <div className={styles.leftContainer}>Welcome {name}</div>
              ...
              <div className={styles.notifications}>
                ...
                <div>
                  <div className={styles.notificationsTop}>
                    ...
                    <p style={{ margin: 0, marginBottom: 9, fontSize: 10 }}>
                  ...
                  <div className={styles.notificationsBottom}>
                    <p style={{ margin: 0, marginBottom: 9, fontSize: 12 }}>
                      7 hours ago
                    </p>
                  </div>
                </div>
